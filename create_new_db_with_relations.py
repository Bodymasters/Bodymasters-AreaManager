...
app.config['SQLALCHEMY_DATABASE_URI'] = 'sqlite:///' + os.path.join(basedir, 'app_new.db')
...
with app.app_context():
    ...
    if os.path.exists(os.path.join(basedir, 'app_new.db')):
        os.remove(os.path.join(basedir, 'app_new.db'))
    ...
    for facility_name in facilities_data:
        facility = Facility(name=facility_name, is_active=True)
