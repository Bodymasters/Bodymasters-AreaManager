...
# معالجة القيم الفارغة في عمود manager_name
if 'manager_name' in club_df.columns:
    club_df['manager_name'] = club_df['manager_name'].fillna('غير محدد')

# حفظ البيانات في ملف CSV للاحتفاظ بها
club_df.to_csv('club_backup_fixed3.csv', index=False, encoding='utf-8-sig')
print("تم حفظ بيانات جدول club في ملف club_backup_fixed3.csv")
