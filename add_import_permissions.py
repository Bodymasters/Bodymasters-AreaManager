...
# قائمة بصلاحيات الاستيراد الجديدة
import_permissions = [
    {"name": "استيراد النوادي من الإكسل", "code": "import_clubs_excel"},
    {"name": "استيراد المرافق من الإكسل", "code": "import_facilities_excel"},
    {"name": "استيراد الموظفين من الإكسل", "code": "import_employees_excel"}
]

# إضافة الصلاحيات الجديدة
for perm_data in import_permissions:
